% This skript shows the pipeline to calculate the mean pixel density of the 2D proximal femur.
...
% select DRR image of the DXA region 
[cropped_DRR_IMG] = select_DXA_region_DRR_label(DRR_IMG, two_cm_distal_DRR_IMG, Neck_superior_DRR_IMG, Neck_inferior_DRR_IMG, Neck_anterior_DRR_IMG, Neck_posterior_DRR_IMG);
